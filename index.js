...
/* Task 1a: write a function to return more menu items with the same
 ...
 * object that automatically calculates price given a string as a
 * parameter.
...
/* Task 7: Write a function to return a review based on the index of
   ...
   and should return a string in the format `{name} gave the
   restaurant a {rating}, and their feedback was: {feedback}`

   * For example, if getReviewByIndex is invoked with reviews and the
   * number 0 it will return `Daniela gave the restaurant a 5 star
...
/* Task 8: Write a function to get information about the most recent
 * review called `getLastReview`

   getLastReview should accept:
   (1) an array of objects

   and should return a string in the format `name} gave the restaurant
   a {rating}, and their feedback was: {feedback}`

   For example, if getLastReview is invoked passing the reviews array
   it will return `Reyna gave the restaurant a 3.5 star review and
...
/** STRETCH 1: Write a function called `getReviewByRating` that
 * returns an array containing all reviews in a certain range. Your
 * function should accept:
    ...
    [{name: "Miranda", rating: 4, feedback:"fun trivia and cool
    vibes"}, {name: "Wen", rating: 4.5, feedback:"I don't leave my
    house often, but when I do, it's for this place. Highly
    reccomend."}, {name:"Lauren", rating: 4, feedback: "Absolutely
    love that they have karaoke Fridays! Food and drink selection is
    okay."}]
*/
